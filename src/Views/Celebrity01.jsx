...
export default function Celebrity01() {
			...
			<div className="col-md-12">
				<div className="hero-ct">
					...
					<ul className="breadcumb">
						...
						<li> <span className="ion-ios-arrow-right"></span> celebrity listing</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div className="row ipad-width2">
			<div className="col-md-9 col-sm-12 col-xs-12">
				<div className="topbar-filter">
					...
					<a href="celebritylist.html" className="list"><i className="ion-ios-list-outline "></i></a>
					<a  href="celebritygrid01.html" className="grid"><i className="ion-grid active"></i></a>
				</div>
				<div className="celebrity-items">
					<div className="ceb-item">
						<a href="celebritysingle.html"><img src="images/uploads/ceb1.jpg" alt=""v/></a>
