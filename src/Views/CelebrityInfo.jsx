		...
		<div className="row ipad-width2">
			<div className="col-md-9 col-sm-12 col-xs-12">
				<div className="topbar-filter">
					<p className="pad-change">Found <span>1,608 celebrities</span> in total</p>
					<label>Sort by:</label>
					<select>
					...
					<a href="celebritylist.html" className="list"><i className="ion-ios-list-outline active"></i></a>
					<a  href="celebritygrid01.html" className="grid"><i className="ion-grid "></i></a>
				</div>
				<div className="row">
					<div className="col-md-12">
